              ...
              <div className="space-y-4">
                {recentTransactions.length > 0 ? (
                  recentTransactions.map((t) => (
                    <div key={t._id} className="flex items-center justify-between group p-3 hover:bg-gray-50 rounded-lg transition-all border border-transparent hover:border-gray-100">
            ...
            <Card className="bg-white border-none shadow-sm h-full min-h-[400px]">
              ...
              <div className="space-y-4">
                {Array.isArray(notes) && notes.length > 0 ? (
                  notes.map((note) => (
                    <div key={note._id} className={`p-4 rounded-lg border transition-all space-y-2 relative group ${
                  ...
                  <div className="flex flex-col items-center justify-center py-10 text-gray-400 border-2 border-dashed border-gray-100 rounded-lg">
          ...
          {isNoteModalOpen && (
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
              ...
              <motion.div 
                ...
                className="relative w-full max-w-md bg-white border border-gray-100 rounded-lg shadow-2xl flex flex-col max-h-[90vh]"
              >
                {/* Fixed Header */}
                <div className="flex items-center justify-between p-8 md:p-10 pb-4">
                  ...
                  <button 
                    onClick={() => setIsNoteModalOpen(false)} 
                    className="p-3 hover:bg-gray-100 rounded-lg text-gray-400 transition-colors"
                  >
                    <X size={24} />
                  </button>
                </div>
