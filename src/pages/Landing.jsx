      ...
      <section className="w-full max-w-7xl px-8 py-20 grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <motion.div 
            ...
            className="bg-white rounded-3xl p-10 border border-gray-100 shadow-sm hover:shadow-xl hover:border-primary-100 transition-all group text-center"
          >
            <div className="w-16 h-16 bg-primary-50 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 group-hover:bg-primary-100 transition-all">
